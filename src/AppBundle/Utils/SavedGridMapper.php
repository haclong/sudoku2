...
class SavedGridMapper {
    /**
     * 
     * @param json $json {"grid":[{"id":"t.0.0","value":"1"},{"id":"t.0.1","value":"2"},{"id":"t.3.3","value":""}]}
     * @return SavedGrid
     */
